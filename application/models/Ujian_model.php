...
class Ujian_model extends CI_Model {
    ...
    {
        $this->datatables->select('a.id_ujian, a.token, a.nama_ujian, b.nama_pelajaran, a.jumlah_soal, CONCAT(a.tgl_mulai, " <br/> (", a.waktu, " Menit)") as waktu, a.jenis');
    ...
    {
        $this->datatables->select("a.id_ujian, e.nama_guru, d.nama_kelas, a.nama_ujian, b.nama_pelajaran, a.jumlah_soal, CONCAT(a.tgl_mulai, ' <br/> (', a.waktu, ' Menit)') as waktu,  (SELECT COUNT(id) FROM h_ujian h WHERE h.siswa_id = {$id} AND h.ujian_id = a.id_ujian) AS ada");
        $this->datatables->from('m_ujian a');
        $this->datatables->join('pelajaran b', 'a.pelajaran_id = b.id_pelajaran');
    ...
    public function getUjianById($id)
    {
        ...
        $this->db->join('pelajaran c', 'a.pelajaran_id=c.id_pelajaran');
    ...
    public function getSoal($id)
    {
        ...
        $this->db->where('pelajaran_id', $ujian->pelajaran_id);
    ...
    public function getHasilUjian($nip = null)
    {
        ...
        $this->datatables->select('c.nama_pelajaran, d.nama_guru');
        $this->datatables->from('h_ujian a');
        $this->datatables->join('m_ujian b', 'a.ujian_id = b.id_ujian');
        $this->datatables->join('pelajaran c', 'b.pelajaran_id = c.id_pelajaran');
