        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    <h4>Pelajaran <i class="fa fa-book pull-right"></i></h4>
            ...
            <div class="col-sm-4">
                <?=form_open('ujian/save', array('id'=>'formujian'), array('method'=>'edit','guru_id'=>$guru->id_guru, 'pelajaran_id'=>$pelajaran->pelajaran_id, 'id_ujian'=>$ujian->id_ujian))?>
