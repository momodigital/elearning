        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    <ol class="pl-4">
                        <li>
                            Anda belum menambahkan master data guru (Master guru kosong/belum ada data sama sekali).
                        </li>
                        <li>
                            Guru sudah ditambahkan, jadi anda tidak perlu tambah lagi. 
                            Anda hanya perlu mengedit data kelas guru nya saja.
                        </li>
                    </ol>
                </div>
            </div>
