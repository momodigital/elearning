    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                    <?=form_open('jurusanpelajaran/save', array('id'=>'jurusanpelajaran'), array('method'=>'edit', 'pelajaran_id'=>$id_pelajaran))?>
                <div class="form-group">
                    <label>Pelajaran</label>
                    <input type="text" readonly="readonly" value="<?=$pelajaran->nama_pelajaran?>" class="form-control">
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/jurusanpelajaran/edit.js"></script>