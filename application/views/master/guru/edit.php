        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    ...
                    <select name="pelajaran" id="pelajaran" class="form-control select2" style="width: 100%!important">
                        <option value="" disabled selected>Pilih Pelajaran</option>
                        <?php foreach ($pelajaran as $row) : ?>
                            <option <?=$data->pelajaran_id===$row->id_pelajaran?"selected":""?> value="<?=$row->id_pelajaran?>"><?=$row->nama_pelajaran?></option>
                        <?php endforeach; ?>
                    </select>
                    <small class="help-block"></small>
                </div>
